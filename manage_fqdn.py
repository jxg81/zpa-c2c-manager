...
from const import ZPA_CLIENT_ID, ZPA_CLIENT_SECRET, ZPA_CUSTOMER_ID, ZCC_CLIENT_ID, ZCC_CLIENT_SECRET, ZCC_CLOUD, DOMAIN_SUFFIX
...
def chunk_list(lst: list, chunk_size: int = 2000) -> list:
    """
    Create a list of lists with of nominated chunk size
